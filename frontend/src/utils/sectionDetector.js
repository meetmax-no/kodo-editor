...
export function detectSections(data) {
  ...
  for (const [key, value] of Object.entries(data)) {
    ...
    // V4.1 fix: Arrays-of-primitives behandles som rot-felt (én redigerbar liste)
    // og vises i RootPrimitivesPanel via ListEditModal. Tidligere ble disse
    // klassifisert som UNKNOWN og falt ut helt — bug rapportert for f.eks.
    // emojiPresets i meetmax.json.
